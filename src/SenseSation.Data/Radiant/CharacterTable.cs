...
/// <summary>
/// Maps Valorant agent (character) content UUIDs to display names. UUIDs are the
/// canonical values from valorant-api.com; names match the icon filenames in
/// wwwroot/agents so the same name works for both display and the icon src.
/// </summary>
